...
def write_log(w):
    file_name = config.sys_path+'/data/' + datetime.date.today().strftime('%m%d') + "_{}.log".format("bert_base")
...
def train(epoch_num):
    ...
    for i in range(epoch_num):
        ...
        min_test_epoch_loss=train_one_epoch(config.sys_path+'/data/bert/',min_test_epoch_loss,device0,device1,
